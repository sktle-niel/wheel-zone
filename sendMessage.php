...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $mail->Body = "
            ...
            <body>
                <div class='container'>
                    ...
                    <div class='footer'>
                        <p>This email was sent from the contact form on Two Wheels Zone website.</p>
        ...
        $mail->send();
        header('Location: public/contactUs.php?status=success');
        exit;
    } catch (Exception $e) {
        echo "Failed to send message. Mailer Error: {$mail->ErrorInfo}";
    }
} else {
    header('Location: public/contactUs.php');
    exit;
}
?>
